...
BEGIN
	...
	seg <= "0000001" WHEN data4 = "0000" ELSE --0
	       ...
	       "1111111";
	-- MODIFIED LAB CODE TO TURN ON A DIGIT IF IT IS NON-ZERO
	anode <= "1110" WHEN dig = "00" and data /= X"0000" ELSE
	         "1101" WHEN dig = "01" and data(15 downto 4) /= X"000" ELSE
	         "1011" WHEN dig = "10" and data(15 downto 8) /= X"00" ELSE
	         "0111" WHEN dig = "11" and data(15 downto 12) /= X"0" ELSE
	         "1111";
END Behavioral;